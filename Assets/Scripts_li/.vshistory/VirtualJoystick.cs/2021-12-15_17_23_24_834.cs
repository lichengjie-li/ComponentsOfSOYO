...
public class VirtualJoystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    /// </summary>
    [SerializeField]
    RectTransform stickImg;
    /// <summary>
    /// 摇杆拖拽点
    /// </summary>
    [SerializeField]
    RectTransform dragImg;

    private void Awake()
    {
        stickImg = transform.GetChild(0).GetComponent<RectTransform>();
        dragImg = stickImg.transform.GetChild(0).GetComponent<RectTransform>();
    }

    /// <summary>
    /// 摇杆半径
    /// </summary>
    private float radius => (stickImg.sizeDelta.x - dragImg.sizeDelta.x) / 2;
